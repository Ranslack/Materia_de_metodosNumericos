...
public class BiseccionVisual extends javax.swing.JFrame {
    ...
    javax.swing.JSlider sldGrado=new javax.swing.JSlider(1,6,1);
    javax.swing.JLabel lblGrado=new javax.swing.JLabel("Grado de la ecuación");
    ...
    javax.swing.JLabel lblgrado=new javax.swing.JLabel("Constante");
    ...
    private void btncargarsladerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncargarsladerActionPerformed
        ...
        ActionListener oido=new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //Aqui va mi codigo
                btnspiner.setText("0");
                btnspiner1.setText("0");
                btnspiner2.setText("0");
                btnspiner3.setText("0");
                btnspiner4.setText("0");
                btnspiner5.setText("0");
                btnspiner6.setText("0");
                ...
                String Xa=txtintervalo1.getText(); //xa
                xa=Double.parseDouble(Xa);
                
                // System.out.println("Digita valorr de b: ");
                String Xb=txtintervalo2.getText(); //xa
                    ...
                    case 6:
                        ...
                        if(comp<0){
                            ...
                            do{
                                count++;
                                System.out.println("----ITERADOR---- "+count);
                                System.out.println("xa: "+String.format("%."+redondeo+"f",xa)+ " xb: "+String.format("%."+redondeo+"f",xb));
                                //----------------------------ERROR
                                xrv=xr;
                                xr=(xa+xb)/2; //Punto Medio. 
                                System.out.println("xr: "+String.format("%."+redondeo+"f",xr));
                                ...
                                //---------------------------------
                                fxr=(valor6*(Math.pow(xr,6))+valor5*(Math.pow(xr,5))+valor4*(Math.pow(xr,4))+valor3*(Math.pow(xr,3))+valor2*(Math.pow(xr,2)) + valor1*(Math.pow(xr,1)) + valor );// <--------
                                System.out.println("fxr: "+String.format("%."+redondeo+"f",fxr));
                                if(fxr==0){
                                    System.out.println("Encontro la raiz: "+String.format("%."+redondeo+"f",xr));
                                    return;
                                }else if(fxa*fxr<0){
                                    xb=xr;
                                }else if(fxb*fxr<0){
